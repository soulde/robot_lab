...
Run simulator-dependent checks inside the pinned Isaac Lab Docker image. Record
the image digest, repository commit, configuration, and seed in the experiment
manifest.
