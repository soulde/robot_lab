...
##
# use local assets
from robot_lab.assets.deeprobotics import DEEPROBOTICS_DR02_STANDARD_CFG  # isort: skip
...
class DeeproboticsDR02StandardRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_hip_l1", -0.2, [".*hip_[xz].*"])
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_arms_l1", -0.2, [".*shoulder_.*", ".*elbow"])
